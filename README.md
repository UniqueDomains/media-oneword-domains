...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C195%20rows-8250df">
...
Daily-updated dataset of available and resale .media one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 7,195 rows · **Live catalog:** 7,194 domains
...
- `media.csv` — public CSV extract (7,195 rows)
- `media.json` — public JSON extract (7,195 rows)
...
| kill.media      | available | $7.99     | $60.99        | 62             | 20     | 4      | name.com                                            |
...
| ----------------------- | ------------------------------------------------ |
| 7,195-row public sample | 7,194 live domains                               |
