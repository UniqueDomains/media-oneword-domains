# Available .MEDIA One-Word Domains (9,873)
...
> The full live catalog for this exact search currently contains **9,873 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,873 domains · **Median ask:** $14.01 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,873 live domains                         |
...
> Unique Domains. *Available .MEDIA One-Word Domains*. Version 2026-05-08. Public GitHub extract for the exact Unique Domains search represented by this repository.
