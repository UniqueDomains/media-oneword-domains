# Available .MEDIA One-Word Domains (7,194)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C193%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-7%2C194%20domains-6f42c1">
...
> **Important:** this repository is a **public 7,193-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **7,194 domains** on the canonical page below.

**Public extract:** 7,193 rows · **Live catalog:** 7,194 domains
...
- `media.csv` — public CSV extract (7,193 rows)
- `media.json` — public JSON extract (7,193 rows)
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------------------------------------------- |
| silly.media     | available | $7.99     | $60.99        | 82             | 23     | 5      | name.com                                            |
...
| expert.media    | premium   | $1,000    | $1,000        | 104            | 30     | 6      | name.com                                            |
...
| sorry.media     | available | $7.99     | $60.99        | 140            | 20     | 5      | name.com                                            |
| box.media       | resell    | —         | —             | 68             | 78     | 3      | Porkbun LLC                                         |
...
| ----------------------- | ------------------------------------------------ |
| 7,193-row public sample | 7,194 live domains                               |
...
> Unique Domains. *Available .MEDIA One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
